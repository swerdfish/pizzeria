	...
	private void fillDatabase() {
		if (orderRepository.findAll().isEmpty() || customerRepository.findAll().isEmpty()) {
			...
			Pizza p1 = new Pizza(PizzaType.THIN_CRUST,
					new HashSet<Toppings>(Arrays.asList(Toppings.ANCHOVY,Toppings.BASIL)),
					6.0,
					PizzaSize.PERSONAL);
			Pizza p2 = new Pizza(PizzaType.DEEP_DISH,
					new HashSet<Toppings>(Arrays.asList(Toppings.CHEESE,Toppings.BACON)),
					8.0,
					PizzaSize.SMALL);
			Pizza p3 = new Pizza(PizzaType.SICILIAN,
					new HashSet<Toppings>(Arrays.asList(Toppings.BROCCOLI,Toppings.PINEAPPLE)),
					10.0,
					PizzaSize.MEDIUM);
			Pizza p4 = new Pizza(PizzaType.STUFFED,
					new HashSet<Toppings>(Arrays.asList(Toppings.TOMATO,Toppings.CHEESE,Toppings.CHICKEN)),
					11.0,
					PizzaSize.LARGE);
			Pizza p5 = new Pizza(PizzaType.CLASSIC,
					new HashSet<Toppings>(Arrays.asList(Toppings.BACON)),
					9.0,
					PizzaSize.XLARGE);
			...
			Customer c1 = new Customer(new ObjectId(),
					"Jeff@pizza.com", 
					"Jeff password",
					"Jeff",
					"Jeffson",
					"+11231231234",
					a1,
					new Customer.PaymentCard(1234445L, "11/22", (short)182, a1),
					Arrays.asList(p1, p2));
			Customer c2 = new Customer(new ObjectId(),
					"Bezo@pizza.com",
					"Bezo password",
					"Bezo",
					"Jeffs",
					"+11231231235",
					a2, 
					new Customer.PaymentCard(1241242L, "02/25", (short)231, a2),
					Arrays.asList(p2, p3));
			Customer c3 = new Customer(new ObjectId(),
					"Juan@pizza.com",
					"Juan password",
					"Juan",
					"Gomez",
					"+11231231236",
					a3,
					new Customer.PaymentCard(5674423L, "12/21", (short)323, a3),
					Arrays.asList(p3, p4));
			Customer c4 = new Customer(new ObjectId(),
					"Aaron@pizza.com",
					"Aaron password",
					"Aaron",
					"Rodgers",
					"+1123123123457",
					a4,
					new Customer.PaymentCard(78945345L, "10/27", (short)557, a4),
					Arrays.asList(p4, p5));
			Customer c5 = new Customer(new ObjectId(), 
					"Stephanie@pizza.com",
					"Stephanie password",
					"Stephanie",
					"Gruverie",
					"+11231231238",
					a5,
					new Customer.PaymentCard(6743432L, "01/21", (short)783, a5), 
					Arrays.asList(p1, p5));
